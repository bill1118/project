            ...
            <main>
                <section>
                    <div className="boxleft">
                        <div className="head">
                            <img src="./images/icon/Userm.svg" alt="" />
                            <p>shenhuo68</p>
                        </div>
                        <div className="vip">
                        ...
                        <div className="information">
                            <a href="member-personal-information.html">
                                <img src="./images/icon/users.svg" alt="" />
                                <p>個人資料</p>
                            </a>
                        </div>
                        <div className="account">
                            <a href="member-account-binding.html">
                                <img src="./images/icon/link.svg" alt="" />
                                <p>帳戶綁定</p>
                            </a>
                        </div>
                        <div className='order'>
                            <a href="member-order-inquiry.html">
                                <img src="./images/icon/ticket-alt.svg" alt="" />
                                <p>訂單查詢</p>
                            </a>
                        </div>
                            ...
                            <form action="">
                                ...
                                <div className="content">
                                    ...
                                    <div className="gender">
                                        <div>男<input type="radio" name="gender" defaultValue="genderm" /></div>
                                        <div>女<input type="radio" name="gender" defaultValue="genderw" /></div>
                                        <div>不公開<input type="radio" name="gender" defaultValue="gendero" /></div>
                                    </div>
                                    <div className="mail">
                                        <p>shenhuo68@shtravel.com.tw</p>
                                        <button>變更</button>
                                    </div>
                                    <div className="tel">
                                        <p>09+68-686868</p>
                        ...
                        <ul className="menu-list">
                            ...
                            <li className="menu">
                                ...
                                <ul className="submenu">
                                    ...
                                    <li>信箱:shenhuo68@shtravel.com.tw</li>
